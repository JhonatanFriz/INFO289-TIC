...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.parquimetroV1.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.parquimetroV1.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public com.parquimetroV1.b4xdialog _vvvvvvvvvvvvv7 = null;
public com.parquimetroV1.b4xfloattextfield _searchfield = null;
public anywheresoftware.b4a.objects.collections.Map _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = null;
public anywheresoftware.b4a.objects.collections.Map _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = null;
public int _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = 0;
public int _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = 0;
public int _max_limit = 0;
public int _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = 0;
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = null;
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = null;
public String _vvvvvvvvvvvvvvv1 = "";
public String _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = "";
public anywheresoftware.b4a.objects.IME _vvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = null;
public boolean _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = false;
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(anywheresoftware.b4a.objects.collections.List _li,String _full) throws Exception{
int _i = 0;
String _item = "";
int _x = 0;
int _pnlcolor = 0;
...
if (_customlistview1._getsize()>=_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0) { 
if (true) return "";};
...
if (_customlistview1._getsize()==0 && _full.length()>0 && _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4==__c.False) { 
 //BA.debugLineNum = 143;BA.debugLine="pnlColor = ItemHightlightColor";
_pnlcolor = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7;
 }else {
...
_cs.Initialize().Append(BA.ObjectToCharSequence(_item.substring((int) (0),_x))).Color(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6).Append(BA.ObjectToCharSequence(_item.substring(_x,(int) (_x+_full.length())))).Pop();
...
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getSize()>0) { 
 //BA.debugLineNum = 152;BA.debugLine="Dim p As B4XView = ItemsCache.Get(ItemsCache.Si";
_p = new anywheresoftware.b4a.objects.B4XViewWrapper();
_p = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.Get((int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getSize()-1))));
 //BA.debugLineNum = 153;BA.debugLine="ItemsCache.RemoveAt(ItemsCache.Size - 1)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.RemoveAt((int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getSize()-1));
...
_vvvvvvvvvvvvv7 = new com.parquimetroV1.b4xdialog();
 //BA.debugLineNum = 6;BA.debugLine="Public SearchField As B4XFloatTextField";
_searchfield = new com.parquimetroV1.b4xfloattextfield();
 //BA.debugLineNum = 7;BA.debugLine="Private prefixList As Map";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = new anywheresoftware.b4a.objects.collections.Map();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = ((int)0xfffd5c5c);
 //BA.debugLineNum = 10;BA.debugLine="Public ItemHightlightColor As Int = 0x7E008EFF";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = ((int)0x7e008eff);
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = (int) (100);
 //BA.debugLineNum = 13;BA.debugLine="Private ItemsCache As List";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 14;BA.debugLine="Private AllItems As List";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = new anywheresoftware.b4a.objects.collections.List();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = false;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.Initialize();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.Initialize("");
 //BA.debugLineNum = 49;BA.debugLine="Dim jo As JavaObject = SearchField.TextField";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_searchfield._getvvvvvvvvvvvvvvvvvvvvvvvvvvv1 /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ().getObject()));
...
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4) { 
 //BA.debugLineNum = 114;BA.debugLine="SelectedItem = LastTerm";
_vvvvvvvvvvvvvvv1 = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3;
 //BA.debugLineNum = 115;BA.debugLine="xDialog.Close(xui.DialogResponse_Positive)";
_vvvvvvvvvvvvv7._vvvvvvvvvvvvvvvvvvvv4 /*boolean*/ (_vvv5.DialogResponse_Positive);
 }else if(_customlistview1._getsize()>0 && _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.length()>0) { 
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(Object _index) throws Exception{
Object[] _obj = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_obj[(int) (0)]));
 //BA.debugLineNum = 237;BA.debugLine="substringList = obj(1)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(_obj[(int) (1)]));
 //BA.debugLineNum = 238;BA.debugLine="Dim AllItems As List = obj(2)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = new anywheresoftware.b4a.objects.collections.List();
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_obj[(int) (2)]));
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.Clear();
 //BA.debugLineNum = 202;BA.debugLine="substringList.Clear";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.Clear();
...
{
final int step13 = 1;
final int limit13 = (int)(BA.ObjectToNumber(((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5) ? ((Object)(0)) : ((Object)(_itemtolower.length()-1)))));
_start = (int) (0) ;
...
if (_start==0) { 
_m = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4;}
else {
_m = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5;};
...
__c.LogImpl("916252959","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
 //BA.debugLineNum = 228;BA.debugLine="AllItems = Items";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = _items;
 //BA.debugLineNum = 229;BA.debugLine="Return Array(prefixList, substringList, AllItems)";
if (true) return (Object)(new Object[]{(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.getObject()),(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getObject()),(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2.getObject())});
...
public ResumableSub_Show(com.parquimetroV1.b4xsearchtemplate parent,com.parquimetroV1.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
com.parquimetroV1.b4xsearchtemplate parent;
...
parent._searchfield._setvvvvvvvvvvvvvvvvvvvvvvvvvv0 /*String*/ ("");
 //BA.debugLineNum = 75;BA.debugLine="SearchField.TextField.RequestFocus";
parent._searchfield._getvvvvvvvvvvvvvvvvvvvvvvvvvvv1 /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ().RequestFocus();
 //BA.debugLineNum = 77;BA.debugLine="IME.ShowKeyboard(SearchField.TextField)";
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.ShowKeyboard((android.view.View)(parent._searchfield._getvvvvvvvvvvvvvvvvvvvvvvvvvvv1 /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ().getObject()));
...
if ((_term).equals(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3) && _force==__c.False) { 
if (true) return "";};
 //BA.debugLineNum = 87;BA.debugLine="LastTerm = Term";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = _term;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.Add((Object)(_p.getObject()));
 }
};
 };
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2,_str1);
 }else {
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3((anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.Get((Object)(_str2)))),_str1);
 //BA.debugLineNum = 108;BA.debugLine="AddItemsToList(substringList.Get(str2), str1)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3((anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.Get((Object)(_str2)))),_str1);
 };
