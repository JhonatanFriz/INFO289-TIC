...
public class b4ximageview extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.parquimetroV1.b4ximageview");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.parquimetroV1.b4ximageview.class).invoke(this, new Object[] {null});
        else
...
public String _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = "";
public boolean _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = false;
public anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = false;
 //BA.debugLineNum = 14;BA.debugLine="Private mBitmap As B4XBitmap";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper();
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5() throws Exception{
 //BA.debugLineNum = 119;BA.debugLine="Public Sub Clear";
 //BA.debugLineNum = 120;BA.debugLine="mBitmap = Null";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = (anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper(), (android.graphics.Bitmap)(__c.Null));
 //BA.debugLineNum = 121;BA.debugLine="iv.SetBitmap(Null)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.SetBitmap((android.graphics.Bitmap)(__c.Null));
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = BA.ObjectToBoolean(_props.Get((Object)("Round")));
 //BA.debugLineNum = 33;BA.debugLine="mResizeMode = Props.Get(\"ResizeMode\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = BA.ObjectToString(_props.Get((Object)("ResizeMode")));
 //BA.debugLineNum = 34;BA.debugLine="mBackgroundColor = xui.PaintOrColorToColor(Props.";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = _vvv5.PaintOrColorToColor(_props.Get((Object)("BackgroundColor")));
 //BA.debugLineNum = 35;BA.debugLine="mCornersRadius = DipToCurrent(Props.GetDefault(\"C";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = __c.DipToCurrent((int)(BA.ObjectToNumber(_props.GetDefault((Object)("CornersRadius"),(Object)(0)))));
 //BA.debugLineNum = 36;BA.debugLine="mBase.AddView(iv, 0, 0, mBase.Width, mBase.Height";
_vvv4.AddView((android.view.View)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.getObject()),(int) (0),(int) (0),_vvv4.getWidth(),_vvv4.getHeight());
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(String _dir,String _filename) throws Exception{
...
if ((_s).equals(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5)) { 
if (true) return "";};
 //BA.debugLineNum = 73;BA.debugLine="mResizeMode = s";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = _s;
 //BA.debugLineNum = 74;BA.debugLine="Update";
_vvvvvvvvvvv7();
 //BA.debugLineNum = 75;BA.debugLine="End Sub";
return "";
}
public String  _setvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(boolean _b) throws Exception{
...
if (_b==_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6) { 
if (true) return "";};
 //BA.debugLineNum = 51;BA.debugLine="mRound = b";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = _b;
...
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.IsInitialized()==__c.False) { 
if (true) return "";};
...
_bmpratio = (float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getWidth()/(double)_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getHeight());
 //BA.debugLineNum = 82;BA.debugLine="Select mResizeMode";
switch (BA.switchObjectToInt(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5,"FILL","FIT","FILL_WIDTH","FILL_HEIGHT","FILL_NO_DISTORTIONS","NONE")) {
case 0: {
...
_r = (float) (__c.Min(_vvv4.getWidth()/(double)_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getWidth(),_vvv4.getHeight()/(double)_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getHeight()));
 //BA.debugLineNum = 88;BA.debugLine="ImageViewWidth = mBitmap.Width * r";
_imageviewwidth = (float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getWidth()*_r);
 //BA.debugLineNum = 89;BA.debugLine="ImageViewHeight = mBitmap.Height * r";
_imageviewheight = (float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getHeight()*_r);
 break; }
case 2: {
...
_r = (float) (__c.Max(_vvv4.getWidth()/(double)_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getWidth(),_vvv4.getHeight()/(double)_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getHeight()));
...
_imageviewwidth = (float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getWidth());
 //BA.debugLineNum = 102;BA.debugLine="ImageViewHeight = mBitmap.Height";
_imageviewheight = (float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getHeight());
 break; }
default: {
 //BA.debugLineNum = 104;BA.debugLine="Log(\"Invalid resize mode: \"  & mResizeMode)";
__c.LogImpl("910485787","Invalid resize mode: "+_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5,0);
 break; }
}
;
 //BA.debugLineNum = 106;BA.debugLine="iv.SetLayoutAnimated(0, Round(mBase.Width / 2 - I";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.SetLayoutAnimated((int) (0),(int) (__c.Round(_vvv4.getWidth()/(double)2-_imageviewwidth/(double)2)),(int) (__c.Round(_vvv4.getHeight()/(double)2-_imageviewheight/(double)2)),(int) (__c.Round(_imageviewwidth)),(int) (__c.Round(_imageviewheight)));
 //BA.debugLineNum = 107;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7() throws Exception{
anywheresoftware.b4j.object.JavaObject _jo = null;
 //BA.debugLineNum = 135;BA.debugLine="Private Sub UpdateClip";
 //BA.debugLineNum = 136;BA.debugLine="If mRound Then";
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6) { 
 //BA.debugLineNum = 137;BA.debugLine="mBase.SetColorAndBorder(mBackgroundColor, 0, 0,";
_vvv4.SetColorAndBorder(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0,(int) (0),(int) (0),(int) (__c.Min(_vvv4.getWidth()/(double)2,_vvv4.getHeight()/(double)2)));
 }else {
 //BA.debugLineNum = 139;BA.debugLine="mBase.SetColorAndBorder(mBackgroundColor, 0, 0,";
_vvv4.SetColorAndBorder(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0,(int) (0),(int) (0),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1);
 };
...
_jo.RunMethod("setClipToOutline",new Object[]{(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 || _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1>0)});
