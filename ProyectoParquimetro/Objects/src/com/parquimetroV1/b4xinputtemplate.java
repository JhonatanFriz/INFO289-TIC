...
public class b4xinputtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.parquimetroV1.b4xinputtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.parquimetroV1.b4xinputtemplate.class).invoke(this, new Object[] {null});
        else
...
public String _vvvvvvvvvvvvvvvvvvvvvvvvvv0 = "";
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = _vvv5.Color_Red;
 //BA.debugLineNum = 14;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(boolean _allowdecimals,boolean _allownegative) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = "^-?(0|[1-9]\\d*)?(\\.\\d+)?(?<=\\d)$";
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = "^-?(0|[1-9]\\d*)$";
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = _allowdecimals;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvv0 = _textfield1.getText();
 };
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4(_vvvvvvvvvvvvvvvvvvvvvv4);
 //BA.debugLineNum = 31;BA.debugLine="End Sub";
return "";
}
public boolean  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(String _new) throws Exception{
...
if (true) return (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7).equals("") || __c.Regex.IsMatch(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7,_new);
 //BA.debugLineNum = 105;BA.debugLine="End Sub";
return false;
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4(int _bc) throws Exception{
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(int _valid,int _invalid) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = _invalid;
...
public ResumableSub_Show(com.parquimetroV1.b4xinputtemplate parent,com.parquimetroV1.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
com.parquimetroV1.b4xinputtemplate parent;
...
parent._textfield1.setText(BA.ObjectToCharSequence(parent._vvvvvvvvvvvvvvvvvvvvvvvvvv0));
 //BA.debugLineNum = 125;BA.debugLine="Validate(Text)";
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6(parent._vvvvvvvvvvvvvvvvvvvvvvvvvv0);
...
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.ShowKeyboard((android.view.View)(parent._textfield1.getObject()));
...
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(_textfield1.getText())) { 
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6(_new);
 //BA.debugLineNum = 84;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6(String _new) throws Exception{
int _bc = 0;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4(_bc);
