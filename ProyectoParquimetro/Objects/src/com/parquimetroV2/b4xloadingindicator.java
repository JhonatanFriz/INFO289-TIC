...
public class b4xloadingindicator extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.parquimetroV2.b4xloadingindicator");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.parquimetroV2.b4xloadingindicator.class).invoke(this, new Object[] {null});
        else
...
public String _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = "";
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = "";
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = _vvv5.PaintOrColorToColor(_props.Get((Object)("Color")));
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = (int)(BA.ObjectToNumber(_props.Get((Object)("Duration"))));
 //BA.debugLineNum = 32;BA.debugLine="DrawingSubName = \"Draw_\" & style.Replace(\" \", \"\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = "Draw_"+_style.replace(" ","");
...
_vvvvvvvv0.DrawRect(_vvvvvvvv0.getTargetRect(),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1,__c.True,(float) (0));
...
_vvvvvvvv0.DrawLine((float) (__c.DipToCurrent((int) (2))+_i*_dx),(float) (_vvvvvvvv0.getTargetRect().getCenterY()-_r),(float) (__c.DipToCurrent((int) (2))+_i*_dx),(float) (_vvvvvvvv0.getTargetRect().getCenterY()+_r),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1,(float) (__c.DipToCurrent((int) (4))));
 }
};
...
_vvvvvvvv0.DrawCircle((float) (_vvvvvvvv0.getTargetRect().getWidth()-_dotr-_progress*(_vvvvvvvv0.getTargetRect().getCenterX()-__c.DipToCurrent((int) (10)))),_vvvvvvvv0.getTargetRect().getCenterY(),(float) (_dotr),_vv1(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1,(int) (255-200*_progress)),__c.True,(float) (0));
...
_vvvvvvvv0.DrawCircle((float) (_cx),(float) (_cy),(float) (_r),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1,__c.True,(float) (0));
 }else {
...
_vvvvvvvv0.DrawCircle(_vvvvvvvv0.getTargetRect().getCenterX(),_vvvvvvvv0.getTargetRect().getCenterY(),(float) (_vvvvvvvv0.getTargetRect().getCenterX()*_progress),_vv1(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1,(int) (255-255*_progress)),__c.True,(float) (0));
 }
};
...
_vvvvvvvv0.DrawCircle((float) (_vvvvvvvv0.getTargetRect().getCenterX()+_r*__c.SinD(_alpha)),(float) (_vvvvvvvv0.getTargetRect().getCenterY()+_r*__c.CosD(_alpha)),(float) (__c.DipToCurrent((int) (7))),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1,__c.True,(float) (__c.DipToCurrent((int) (1))));
 }
};
...
_vvvvvvvv0.DrawCircle((float) (_maxr+_minr+(_minr+_maxr+__c.DipToCurrent((int) (2)))*2*_i),_vvvvvvvv0.getTargetRect().getCenterY(),_r,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1,__c.True,(float) (0));
 }
};
...
public void  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0() throws Exception{
...
public ResumableSub_MainLoop(com.parquimetroV2.b4xloadingindicator parent) {
this.parent = parent;
}
com.parquimetroV2.b4xloadingindicator parent;
int _myindex = 0;
long _n = 0L;
float _progress = 0f;
...
//do while
this.state = 4;
while (_myindex==parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2) {
this.state = 3;
if (true) break;
}
if (true) break;
...
_progress = (float) ((parent.__c.DateTime.getNow()-_n)/(double)parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3);
...
parent.__c.CallSubNew2(ba,parent,parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4,(Object)(_progress));
