...
public class b4xlongtexttemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.parquimetroV2.b4xlongtexttemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.parquimetroV2.b4xlongtexttemplate.class).invoke(this, new Object[] {null});
        else
...
public Object _vvvvvvvvvvvvvvvvvvvvvvvvvv0 = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvv0 = new Object();
...
public String  _show(com.parquimetroV2.b4xdialog _dialog) throws Exception{
...
_customlistview1._addtextitem(_vvvvvvvvvvvvvvvvvvvvvvvvvv0,(Object)(""));
...
if (BA.fastSubCompare(sub, "SHOW"))
	return _show((com.parquimetroV2.b4xdialog) args[0]);
