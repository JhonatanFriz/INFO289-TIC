...
public class b4xdatetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.parquimetroV2.b4xdatetemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.parquimetroV2.b4xdatetemplate.class).invoke(this, new Object[] {null});
        else
...
public com.parquimetroV2.b4xdialog _vvvvvvvvvvvvvvvvvvv0 = null;
...
_vvvvvvvvvvvvvvvvvvv0 = new com.parquimetroV2.b4xdialog();
...
public ResumableSub_Show(com.parquimetroV2.b4xdatetemplate parent,com.parquimetroV2.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
com.parquimetroV2.b4xdatetemplate parent;
