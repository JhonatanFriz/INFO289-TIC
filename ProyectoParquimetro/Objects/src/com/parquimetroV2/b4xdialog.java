...
public class b4xdialog extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.parquimetroV2.b4xdialog");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.parquimetroV2.b4xdialog.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_Show(com.parquimetroV2.b4xdialog parent,Object _text,Object _yes,Object _no,Object _cancel) {
this.parent = parent;
this._text = _text;
this._yes = _yes;
this._no = _no;
...
com.parquimetroV2.b4xdialog parent;
Object _text;
Object _yes;
Object _no;
Object _cancel;
...
public ResumableSub_ShowCustom(com.parquimetroV2.b4xdialog parent,anywheresoftware.b4a.objects.B4XViewWrapper _content,Object _yes,Object _no,Object _cancel) {
this.parent = parent;
...
this.state = 51;
_v = new anywheresoftware.b4a.objects.B4XViewWrapper();
group74 = parent._vvvvvvvvvvvvvvvvvvvvvvv1.GetAllViewsRecursive();
index74 = 0;
...
this.state = 55;
_v = new anywheresoftware.b4a.objects.B4XViewWrapper();
group78 = parent._vvvvvvvvvvvvvvvvvvvvvvv1.GetAllViewsRecursive();
index78 = 0;
...
public ResumableSub_ShowTemplate(com.parquimetroV2.b4xdialog parent,Object _dialogtemplate,Object _yes,Object _no,Object _cancel) {
this.parent = parent;
