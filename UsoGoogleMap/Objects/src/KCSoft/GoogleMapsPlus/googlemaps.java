...
public KCSoft.GoogleMapsPlus.main _vv3 = null;
public static String  _process_globals() throws Exception{
 //BA.debugLineNum = 3;BA.debugLine="Sub Process_Globals";
 //BA.debugLineNum = 7;BA.debugLine="End Sub";
return "";
}
public static String  _v5(anywheresoftware.b4a.BA _ba,float _centerlat,float _centerlong,int _zoom,boolean _maptypecontrol,boolean _dispzoomcontrol,boolean _dispscalecontrol,String _scalecontrolposition,boolean _dispmarkercenter,anywheresoftware.b4a.objects.collections.List _markerlat,anywheresoftware.b4a.objects.collections.List _markerlong,boolean _dispmarkers,boolean _disppolyline,String _polylinecolor,float _polylineopacity,int _polylinewidth,anywheresoftware.b4a.objects.WebViewWrapper _mapwebview) throws Exception{
String _htmlcode = "";
int _i = 0;
int _j = 0;
